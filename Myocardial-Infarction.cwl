...
steps:
  ...
  myocardial-infarction-postmi---primary:
    run: myocardial-infarction-postmi---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  old-myocardial-infarction---primary:
    run: old-myocardial-infarction---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: myocardial-infarction-postmi---primary/output
  myocardial-infarction-healed---primary:
    run: myocardial-infarction-healed---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: old-myocardial-infarction---primary/output
  subsequent-myocardial-infarction---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: myocardial-infarction-healed---primary/output
  ...
  myocardial-infarction-hypertension---primary:
    run: myocardial-infarction-hypertension---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  myocardial-infarction-attack---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: myocardial-infarction-hypertension---primary/output
  infarct---primary:
    run: infarct---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  myocardial-infarction-thrombosis---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: infarct---primary/output
  myocardial-infarction-post---primary:
    run: myocardial-infarction-post---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  output-cases:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: myocardial-infarction-post---primary/output
class: Workflow
inputs:
  inputModule1:
    id: inputModule1
